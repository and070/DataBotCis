    ...
    class AutoppSS
    {
        ...
        public void ProcessAutopp()
        {
            ...
            if (newOppRequests1.Rows.Count > 0)
            {
                ...
                foreach (DataRow oppReq in newOppRequests1.Rows)
                {
                    ...
                    employeeCreatorData = crud.Select(sqlEmployeeCreatorData, "MIS").Rows[0];
                    ...
                    string sqlEmployeeResponsible = $"select * from MIS.digital_sign where id=(SELECT employee FROM autopp_db.SalesTeam where role= 41 and oppId= {oppGestion.id})";
                    //DataRow employeeResponsibleDt = crud.Select( sqlEmployeeResponsible, "databot_db").Rows[0];
                    employeeResponsibleData = crud.Select(sqlEmployeeResponsible, "databot_db").Rows[0];
                    ...
                    client = crud.Select(sqlClient, "databot_db").Rows[0];
        ...
        public bool Step1CreateOpp()
        {
            ...
            try
            {
                ...
                {//Fallo 
                    ...
                    crud.Update(updateQuery, "autopp_db");
                    return false;
                }
                ...
                crud.Update(updateQueryOpp, "autopp_db");
        ...
        public bool Step2CreateLDR()
        {
            ...
            try
            {
                ...
                if (filesRoutes.Count > 0) //Verifica si se debe subir algún LDRS.
                {
                    ...
                    {
                        while (sap.CheckLogin(mandante) && blockByAutoppLDR == false)
                        {
                            console.WriteLine($"Mandante de SAP {mandante} bloqueado, esperando su desbloqueo...");
        ...
        public void Step3CreateBAWRequirements()
        {
            ...
            try
            {
                ...
                crud.Update(updateQueryBAW, "autopp_db");
            ...
            while (mail.GetAttachmentEmail("BAW Notificaciones", "Procesados", "Procesados BAW"))
            {
                ...
                if (subject.Contains("ha sido finalizada".Replace(" ", "")))
                {
                    ...
                    try
                    {
                        ...
                        oppRow = crud.Select(sqlOpp, "autopp_db").Rows[0];
                    ...
                    string sqlEmployeeResponsible4 = $"select * from MIS.digital_sign where id=(SELECT employee FROM autopp_db.SalesTeam where role= 41 and oppId= {oppGestion.id})";
                    //DataRow employeeResponsibleDt = crud.Select( sqlEmployeeResponsible4, "databot_db").Rows[0];
                    employeeResponsibleData = crud.Select(sqlEmployeeResponsible4, "databot_db").Rows[0];
                    ...
                    if (oppRow != null)
                    {
                        ...
                        crud.Update(sqlUpdate, "autopp_db");
                        #endregion*/
                        ...
                        try
                        {
                            ...
                            countBAWReqPendingsTable = crud.Select(sql1, "autopp_db");
                            ...
                            //log.LogDeCambios("Verficación final", root.BDProcess, "test", "Recibir y verificar solicitud", "Realizar la verificación final para finalizar el proceso del client y opp: " , "EPIEDRATEST");
                            //respFinal = respFinal + "\\n" + "Realizar la verificación final para finalizar el proceso del client y opp: TEST!!" ;
                ...
                else if (subject.Contains("debe ser corregido".Replace(" ", "")))
                {
                    ...
                    try
                    {
                     ...
                     ";
                        ...
                        DataTable dtMain = crud.Select(sqlMain, "autopp_db");
                        ...
                        if (dtMain.Rows.Count > 0)
                        {
                            ...
                            crud.Update(sqlUpdateCaseNumberAndStatus, "autopp_db");
            ...
            if (reqsForwardBaw.Rows.Count > 0)
            {
                ...
                foreach (DataRow reqForwardBaw in reqsForwardBaw.Rows)
                {
                    ...
                    try
                    {
                        ...
                        crud.Update(updateQuery7, "autopp_db");
        ...
        private string CreateOppCRM(AutoppInformation oppInformation, string user)
        {
            ...
            func.SetValue("USER", "RPAUSER"); //Agregado
        ...
        private Dictionary<string, string> CreateLDR(AutoppInformation oppInformation)
        {
            ...
            if (oppInformation.LDRS.Count > 0)
            {
                ...
                List<string> listSheetNumberActives = new List<string>();

                for (int i = 0; i < oppInformation.LDRS.Count; i++)
                {
                    string type = oppInformation.LDRS[i].technology;
                    ...
                    switch (type)
                    {
                        ...
                        case "meetings":
                            #region meetings
                            console.WriteLine("Creando Meetings...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[1];

                            //Generales
                            xlWorkSheet.Cells[8, 3].value = oppInformation.LDRS[i].LDR[0].value;

                            //Meetings
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[1].value;

                            //Eventos
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[2].value;
                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[3].value;

                            //Entrenamientos
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[5].value;

                            //Soporte
                            xlWorkSheet.Cells[18, 3].value = oppInformation.LDRS[i].LDR[6].value;

                            //Opcionales
                            xlWorkSheet.Cells[20, 3].value = oppInformation.LDRS[i].LDR[7].value;
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[8].value;

                            listSheetNumberActives.Add(xlWorkSheet.Name);
                            #endregion
                            break;

                        case "telephony":
                            #region telephony
                            console.WriteLine("Creando Telefonía...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[2];

                            //Generales
                            xlWorkSheet.Cells[9, 3].value = oppInformation.LDRS[i].LDR[0].value;
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[1].value;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[2].value;

                            //Sitios
                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[3].value;
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[18, 3].value = oppInformation.LDRS[i].LDR[7].value;
                            xlWorkSheet.Cells[19, 3].value = oppInformation.LDRS[i].LDR[8].value;

                            //Usuarios
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[10].value;
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[11].value;
                            xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[12].value;
                            xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[13].value;
                            xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[14].value;
                            xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            xlWorkSheet.Cells[29, 3].value = oppInformation.LDRS[i].LDR[16].value;

                            //Gateways
                            xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[17].value;
                            xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[18].value;
                            xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[19].value;

                            //Opcionales
                            xlWorkSheet.Cells[35, 3].value = oppInformation.LDRS[i].LDR[20].value;
                            xlWorkSheet.Cells[36, 3].value = oppInformation.LDRS[i].LDR[21].value;
                        ...
                        case "devices":
                            #region devices
                            console.WriteLine("Creando Dispositivos...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[3];

                            //Sala de Videoconferencia
                            xlWorkSheet.Cells[8, 3].value = oppInformation.LDRS[i].LDR[0].value;
                            xlWorkSheet.Cells[9, 3].value = oppInformation.LDRS[i].LDR[1].value;
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[2].value;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[3].value;
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[7].value;

                            //Perfiles de teléfono
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[8].value;
                            xlWorkSheet.Cells[18, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[19, 3].value = oppInformation.LDRS[i].LDR[10].value;
                            xlWorkSheet.Cells[20, 3].value = oppInformation.LDRS[i].LDR[11].value;
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[12].value;

                            //Dispositivos compartidos
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[13].value;
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[14].value;
                            xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[17].value;

                            //Diademas
                            xlWorkSheet.Cells[29, 3].value = oppInformation.LDRS[i].LDR[18].value;
                            xlWorkSheet.Cells[30, 3].value = oppInformation.LDRS[i].LDR[19].value;
                            xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[20].value;
                            xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[21].value;
                        ...
                        case "contactCenter":
                            ...
                            console.WriteLine("Creando ContactCenter...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[4];
                            ...
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[1].value;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[2].value;
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[3].value;

                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[7].value;
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[8].value;
                            xlWorkSheet.Cells[18, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[19, 3].value = oppInformation.LDRS[i].LDR[10].value;

                            //Canales que desea atender 
                            xlWorkSheet.Cells[22, 3].value = oppInformation.LDRS[i].LDR[11].value;
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[12].value;
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[13].value;
                            xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[14].value;
                            xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[17].value;

                            //Opcionales
                            xlWorkSheet.Cells[30, 3].value = oppInformation.LDRS[i].LDR[18].value;
                            xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[19].value;
                            xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[20].value;
                            xlWorkSheet.Cells[34, 3].value = oppInformation.LDRS[i].LDR[21].value;
                            xlWorkSheet.Cells[35, 3].value = oppInformation.LDRS[i].LDR[22].value;
                            xlWorkSheet.Cells[36, 3].value = oppInformation.LDRS[i].LDR[23].value;
                        ...
                        #region Networking SDN
                        case "dataCenter":
                            #region dataCenter
                            console.WriteLine("Creando Datacenter...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[5];
                            ...
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[7].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[8].value;
                            xlWorkSheet.Cells[19, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[20, 3].value = oppInformation.LDRS[i].LDR[10].value;
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[11].value;

                            //Cargas de trabajo 
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[12].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[13].value;
                            xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[14].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            xlWorkSheet.Cells[29, 3].value = oppInformation.LDRS[i].LDR[17].value;
                            xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[18].value;
                            xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[19].value;
                            xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[20].value;

                            //Servicios
                            xlWorkSheet.Cells[35, 3].value = oppInformation.LDRS[i].LDR[21].value;
                            xlWorkSheet.Cells[36, 3].value = oppInformation.LDRS[i].LDR[22].value;
                        ...
                        case "LANAndWLAN":
                            #region LANAndWLAN
                            console.WriteLine("Creando LAN y WLAN...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[6];
                            ...
                            //Edificios
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[7].value;

                            //Acceso y autenticación
                            xlWorkSheet.Cells[19, 3].value = oppInformation.LDRS[i].LDR[8].value;
                            xlWorkSheet.Cells[20, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[10].value;

                            //Servicios
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[11].value;
                        ...
                        case "WANEnterprise":
                            #region WANEnterprise
                            console.WriteLine("Creando WANEnterprise...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[7];
                            ...
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[3].value;
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[5].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[7].value;
                        ...
                        #region Virtualización GTL
                        case "revenueVMware":
                            #region revenueVMware
                            console.WriteLine("Creando Renovar VMware...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[8];
                        ...
                        case "lenovo":
                            #region lenovo
                            console.WriteLine("Creando Lenovo...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[9];


                            xlWorkSheet.Cells[7, 3].value = oppInformation.LDRS[i].LDR[0].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[8, 3].value = oppInformation.LDRS[i].LDR[1].value;
                            xlWorkSheet.Cells[9, 3].value = oppInformation.LDRS[i].LDR[2].value;
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[3].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            ...
                            xlWorkSheet.Cells[20, 3].value = oppInformation.LDRS[i].LDR[10].value;
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[11].value;
                            xlWorkSheet.Cells[22, 3].value = oppInformation.LDRS[i].LDR[12].value;
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[13].value;
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[14].value;
                            xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            ...
                            xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[17].value;
                            xlWorkSheet.Cells[29, 3].value = oppInformation.LDRS[i].LDR[18].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.;;
                            xlWorkSheet.Cells[30, 3].value = oppInformation.LDRS[i].LDR[19].value;
                            xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[20].value;
                            xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[21].value;
                            xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[22].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[34, 3].value = oppInformation.LDRS[i].LDR[23].value;

                            //I/O Conectividad LAN y SAN
                            xlWorkSheet.Cells[37, 3].value = oppInformation.LDRS[i].LDR[24].value;
                            xlWorkSheet.Cells[38, 3].value = oppInformation.LDRS[i].LDR[25].value;
                            xlWorkSheet.Cells[39, 3].value = oppInformation.LDRS[i].LDR[26].value;
                            xlWorkSheet.Cells[40, 3].value = oppInformation.LDRS[i].LDR[27].value;
                            xlWorkSheet.Cells[41, 3].value = oppInformation.LDRS[i].LDR[28].value;
                            xlWorkSheet.Cells[43, 3].value = oppInformation.LDRS[i].LDR[29].value;
                            xlWorkSheet.Cells[44, 3].value = oppInformation.LDRS[i].LDR[30].value;
                            xlWorkSheet.Cells[45, 3].value = oppInformation.LDRS[i].LDR[31].value;
                            xlWorkSheet.Cells[46, 3].value = oppInformation.LDRS[i].LDR[32].value;
                            xlWorkSheet.Cells[47, 3].value = oppInformation.LDRS[i].LDR[33].value;

                            //Sistema Operativo
                            xlWorkSheet.Cells[49, 3].value = oppInformation.LDRS[i].LDR[34].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[50, 3].value = oppInformation.LDRS[i].LDR[35].value;

                            //Racks y/o Componentes de energía
                            xlWorkSheet.Cells[52, 3].value = oppInformation.LDRS[i].LDR[36].value;
                            xlWorkSheet.Cells[53, 3].value = oppInformation.LDRS[i].LDR[37].value;
                            xlWorkSheet.Cells[54, 3].value = oppInformation.LDRS[i].LDR[38].value;

                            //Servicios
                            xlWorkSheet.Cells[56, 3].value = oppInformation.LDRS[i].LDR[39].value;
                            xlWorkSheet.Cells[57, 3].value = oppInformation.LDRS[i].LDR[40].value;
                            xlWorkSheet.Cells[58, 3].value = oppInformation.LDRS[i].LDR[41].value;
                            xlWorkSheet.Cells[59, 3].value = oppInformation.LDRS[i].LDR[42].value;
                            xlWorkSheet.Cells[60, 3].value = oppInformation.LDRS[i].LDR[43].value;
                            xlWorkSheet.Cells[61, 3].value = oppInformation.LDRS[i].LDR[44].value;
                        ...
                        case "powerNew":
                            #region powerNew
                            console.WriteLine("Creando Power-New...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[12];


                            xlWorkSheet.Cells[7, 3].value = oppInformation.LDRS[i].LDR[0].value;
                            xlWorkSheet.Cells[8, 3].value = oppInformation.LDRS[i].LDR[1].value;
                            ...
                            //Memoria
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[7].value;
                            xlWorkSheet.Cells[18, 3].value = oppInformation.LDRS[i].LDR[8].value;

                            //Tipo de almacenamiento - Slots Internos
                            xlWorkSheet.Cells[20, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[10].value;
                            xlWorkSheet.Cells[22, 3].value = oppInformation.LDRS[i].LDR[11].value;

                            //Almacenamiento interno (1) - Slots Internos 
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[12].value;

                            if (oppInformation.LDRS[i].LDR[12].value == "Power 9")
                            {
                                xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[13].value;
                                xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[14].value;
                                xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[15].value;
                                xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            }

                            if (oppInformation.LDRS[i].LDR[12].value == "Power 10")
                            {
                                xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[17].value;
                                xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[18].value;
                                xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[19].value;
                                xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[20].value;
                            }

                            //Almacenamiento interno (2) slots internos 

                            xlWorkSheet.Cells[30, 3].value = oppInformation.LDRS[i].LDR[21].value;

                            if (oppInformation.LDRS[i].LDR[21].value == "Power 9")
                            {
                                xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[22].value;
                                xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[23].value;
                                xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[24].value;
                                xlWorkSheet.Cells[34, 3].value = oppInformation.LDRS[i].LDR[25].value;
                            }

                            if (oppInformation.LDRS[i].LDR[21].value == "Power 10")
                            {
                                xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[26].value;
                                xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[27].value;
                                xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[28].value;
                                xlWorkSheet.Cells[34, 3].value = oppInformation.LDRS[i].LDR[29].value;
                            }

                            //Expansiones
                            xlWorkSheet.Cells[36, 3].value = oppInformation.LDRS[i].LDR[30].value;
                            xlWorkSheet.Cells[37, 3].value = oppInformation.LDRS[i].LDR[31].value;
                            xlWorkSheet.Cells[38, 3].value = oppInformation.LDRS[i].LDR[32].value;
                            xlWorkSheet.Cells[39, 3].value = oppInformation.LDRS[i].LDR[33].value;

                            //Tarjetas (I/O Conectividad LAN y SAN)
                            xlWorkSheet.Cells[41, 3].value = oppInformation.LDRS[i].LDR[34].value;
                            xlWorkSheet.Cells[42, 3].value = oppInformation.LDRS[i].LDR[35].value;
                            xlWorkSheet.Cells[43, 3].value = oppInformation.LDRS[i].LDR[36].value;
                            xlWorkSheet.Cells[44, 3].value = oppInformation.LDRS[i].LDR[37].value;
                            xlWorkSheet.Cells[45, 3].value = oppInformation.LDRS[i].LDR[38].value;
                        ...
                        case "powerMES":
                            #region powerMES
                            console.WriteLine("Creando Power-MES...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[13];


                            xlWorkSheet.Cells[7, 3].value = oppInformation.LDRS[i].LDR[0].value;//.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.

                            //Recursos
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[1].value;//.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[2].value;
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[3].value;
                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            ...
                            xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            xlWorkSheet.Cells[29, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            xlWorkSheet.Cells[30, 3].value = oppInformation.LDRS[i].LDR[17].value;
                        ...
                        case "newStorage":
                            #region newStorage
                            console.WriteLine("Creando Storage-Nuevo...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[10];
                            ...
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[3].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[7].value;
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[8].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[9].value;
                            xlWorkSheet.Cells[17, 3].value = oppInformation.LDRS[i].LDR[10].value;
                            xlWorkSheet.Cells[18, 3].value = oppInformation.LDRS[i].LDR[11].value;
                            xlWorkSheet.Cells[19, 3].value = oppInformation.LDRS[i].LDR[12].value;

                            //Tipo MidRange
                            xlWorkSheet.Cells[21, 3].value = oppInformation.LDRS[i].LDR[13].value;
                            xlWorkSheet.Cells[22, 3].value = oppInformation.LDRS[i].LDR[14].value;
                            xlWorkSheet.Cells[23, 3].value = oppInformation.LDRS[i].LDR[15].value;
                            xlWorkSheet.Cells[24, 3].value = oppInformation.LDRS[i].LDR[16].value;
                            xlWorkSheet.Cells[25, 3].value = oppInformation.LDRS[i].LDR[17].value;
                            xlWorkSheet.Cells[26, 3].value = oppInformation.LDRS[i].LDR[18].value;
                            xlWorkSheet.Cells[27, 3].value = oppInformation.LDRS[i].LDR[19].value;
                            xlWorkSheet.Cells[28, 3].value = oppInformation.LDRS[i].LDR[20].value;
                            xlWorkSheet.Cells[29, 3].value = oppInformation.LDRS[i].LDR[21].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.;;
                            xlWorkSheet.Cells[30, 3].value = oppInformation.LDRS[i].LDR[22].value;
                            xlWorkSheet.Cells[31, 3].value = oppInformation.LDRS[i].LDR[23].value;
                            xlWorkSheet.Cells[32, 3].value = oppInformation.LDRS[i].LDR[24].value;
                            xlWorkSheet.Cells[33, 3].value = oppInformation.LDRS[i].LDR[25].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[34, 3].value = oppInformation.LDRS[i].LDR[26].value;
                            xlWorkSheet.Cells[35, 3].value = oppInformation.LDRS[i].LDR[27].value;

                            //Type enterprise
                            xlWorkSheet.Cells[37, 3].value = oppInformation.LDRS[i].LDR[28].value;
                            xlWorkSheet.Cells[38, 3].value = oppInformation.LDRS[i].LDR[29].value;
                            xlWorkSheet.Cells[39, 3].value = oppInformation.LDRS[i].LDR[30].value;
                            xlWorkSheet.Cells[40, 3].value = oppInformation.LDRS[i].LDR[31].value;
                            xlWorkSheet.Cells[41, 3].value = oppInformation.LDRS[i].LDR[32].value;
                            xlWorkSheet.Cells[42, 3].value = oppInformation.LDRS[i].LDR[33].value;
                            xlWorkSheet.Cells[43, 3].value = oppInformation.LDRS[i].LDR[34].value;
                            xlWorkSheet.Cells[44, 3].value = oppInformation.LDRS[i].LDR[35].value;
                            xlWorkSheet.Cells[45, 3].value = oppInformation.LDRS[i].LDR[36].value;
                            xlWorkSheet.Cells[46, 3].value = oppInformation.LDRS[i].LDR[37].value;
                            xlWorkSheet.Cells[47, 3].value = oppInformation.LDRS[i].LDR[38].value;
                            xlWorkSheet.Cells[48, 3].value = oppInformation.LDRS[i].LDR[39].value;

                            //Software subscription
                            xlWorkSheet.Cells[50, 3].value = oppInformation.LDRS[i].LDR[40].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.
                            xlWorkSheet.Cells[51, 3].value = oppInformation.LDRS[i].LDR[41].value;

                            //Switch Externo
                            xlWorkSheet.Cells[53, 3].value = oppInformation.LDRS[i].LDR[42].value;
                            xlWorkSheet.Cells[54, 3].value = oppInformation.LDRS[i].LDR[43].value;
                            xlWorkSheet.Cells[55, 3].value = oppInformation.LDRS[i].LDR[44].value;
                            xlWorkSheet.Cells[56, 3].value = oppInformation.LDRS[i].LDR[45].value;
                            xlWorkSheet.Cells[57, 3].value = oppInformation.LDRS[i].LDR[46].value;
                            xlWorkSheet.Cells[58, 3].value = oppInformation.LDRS[i].LDR[47].value;
                            xlWorkSheet.Cells[59, 3].value = oppInformation.LDRS[i].LDR[48].value;
                            xlWorkSheet.Cells[60, 3].value = oppInformation.LDRS[i].LDR[49].value;
                            xlWorkSheet.Cells[61, 3].value = oppInformation.LDRS[i].LDR[50].value;
                            xlWorkSheet.Cells[62, 3].value = oppInformation.LDRS[i].LDR[51].value;
                            xlWorkSheet.Cells[63, 3].value = oppInformation.LDRS[i].LDR[52].value;
                            xlWorkSheet.Cells[64, 3].value = oppInformation.LDRS[i].LDR[53].value;

                            //Servicios
                            xlWorkSheet.Cells[66, 3].value = oppInformation.LDRS[i].LDR[54].value;
                        ...
                        case "mesStorage":
                            #region mesStorage
                            console.WriteLine("Creando Storage-MES...");

                            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Sheets[11];
                            ...
                            //Storage
                            xlWorkSheet.Cells[9, 3].value = oppInformation.LDRS[i].LDR[1].value;
                            xlWorkSheet.Cells[10, 3].value = oppInformation.LDRS[i].LDR[2].value.Replace("[", "").Replace("]", "").Replace("\r\n", string.Empty).Replace("\",  \"", ", ").Replace("  \"", "").Replace("\"", ""); //Eliminar caracteres del JSON multiselect.;
                            xlWorkSheet.Cells[11, 3].value = oppInformation.LDRS[i].LDR[3].value;
                            xlWorkSheet.Cells[12, 3].value = oppInformation.LDRS[i].LDR[4].value;
                            xlWorkSheet.Cells[13, 3].value = oppInformation.LDRS[i].LDR[5].value;
                            xlWorkSheet.Cells[14, 3].value = oppInformation.LDRS[i].LDR[6].value;
                            xlWorkSheet.Cells[15, 3].value = oppInformation.LDRS[i].LDR[7].value;
                            xlWorkSheet.Cells[16, 3].value = oppInformation.LDRS[i].LDR[8].value;
                ...
                #region Descartar sheets LDRS inactivos

                //Obtener una lista con todos los nombres de las hojas del Excel.
                ...
                for (int e = 0; e < excelSheets.Count; e++)
                {
                    if (!listSheetNumberActives.Contains(excelSheets[e]))
                    {
                        xlApp.DisplayAlerts = false;
                        worksheets = xlWorkBook.Worksheets;
                        worksheets[excelSheets[e]].Delete();
                ...
                #region ELIMINAR CUANDO SE PASE A PRD

                //System.IO.Directory.CreateDirectory(@"C:\Users\epiedra\Documents\SM2\gbm-hub-api\src\assets\files\Autopp\" + oppInformation.id);
                //System.IO.File.Copy(locationLDRToSave, @"C:\Users\epiedra\Documents\SM2\gbm-hub-api\src\assets\files\Autopp\" + oppInformation.id + nameFileExcel, true);


                #endregion


                console.WriteLine("LDR del oportunidad " + oppInformation.opp + " - " + oppInformation.id + " creado con éxito.");
        ...
        public void DownloadsBOMFiles(Dictionary<string, string> filesBOMRoutes, string oppId)
        {
            ...
            DataTable bomTable = crud.Select(sqlBom, "autopp_db");

            foreach (DataRow bomFile in bomTable.Rows)
            {
                //Descargar el archivo del FTP
                bool result = autoppSQL.DownloadFile(bomFile["path"].ToString());
        ...
        private DataTable GetReqsForStatus(string status)
        {
            ...
            DataTable reqTable = crud.Select(sql, "autopp_db");
        ...
        private DataTable oppInfo([Optional] int oppId, string typeInformation)
        {
            ...
            switch (typeInformation)
            {
                ...
                case "LDRS":
                    sql =
                    "SELECT id, oppId, ldrRequest " +
                    "FROM `LDRSFormsRequests` " +
                    $"WHERE oppId={oppId} " +
                    "AND active = 1";
                    break;
            }

            mytable = crud.Select(sql, "autopp_db");
            ...
            if (successOrFailMode == "Success") //Éxito
            {
                ...
                switch (fase)
                {
                    case 3:
                        ...
                        if (oppGestion.opp != "")
                        {
                            titleWebex = $"Creación exitosa de oportunidad - {oppGestion.opp}";
                            ...
                            msgWebex += ", ha sido creada en SAP-CRM satisfactoriamente con el Id: " + oppGestion.opp;

                            if (LDROrBOMDocument == "LDR")
                            {
                                msgWebex += $".\r\n \r\n Además el LDR fue creado, y los requerimientos de BAW ya han sido enviados a los especialistas. Puede consultar el estado de los requerimientos en el botón de solicitudes de Autopp en <a href='{routeSS}'>Smart And Simple</a> de GBM.";
                            }
                            else { msgWebex += $".\r\n \r\n Además los documentos adjuntados fueron cargados, y los requerimientos de BAW ya han sido enviados a los especialistas. Puede consultar el estado en el botón de solicitudes de Autopp en <a href='{routeSS}'>Smart And Simple</a> de GBM."; }

                            msgWebex += "\r\n \r\nSaludos cordiales.";

                            webex.SendCCNotification(employeeCreatorData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex);
                            //webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex);
                            ...
                            if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                            {
                                ...
                                webex.SendCCNotification(employeeResponsibleData["user"] + "@GBM.NET", titleWebex, $"Creación exitosa de oportunidad - {oppGestion.opp}", oppGestion.opp, msgWebex);
                                //webex.SendCCNotification(/*employeeResponsibleData["user"]*/"EPIEDRA" + "@GBM.NET", titleWebex, $"Creación exitosa de oportunidad - {oppGestion.opp}", oppGestion.opp, msgWebex);

                            }

                            //BORRAR CUANDO SE PASE A PRD
                            webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex);
                    ...
                    case 4:
                        ...
                        if (oppGestion.opp != "")
                        {
                            ...
                            //webex.SendCCNotification(/*employeeCreatorData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - { oppGestion.opp}", oppGestion.opp, msgWebex);
                            webex.SendCCNotification(employeeCreatorData["user"].ToString() + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - {oppGestion.opp}", oppGestion.opp, greeting + msgWebex);
                            ...
                            if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                            {
                                ...
                                greeting = process.greeting() + $" estimado(a) {employeeName}";

                                // webex.SendCCNotification(/*employeeResponsibleData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - { oppGestion.opp}", oppGestion.opp, msgWebex);
                                // webex.SendCCNotification(employeeResponsibleData["user"].ToString() + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - {oppGestion.opp}", oppGestion.opp, greeting + msgWebex);

                            }

                            //BORRAR CUANDO SE PASE A PRD
                            webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, greeting + msgWebex);
                    ...
                    case 5:
                        ...
                        if (oppGestion.opp != "")
                        {
                            ...
                            $"del cliente: " + client["name"].ToString();
                            msgWebex += ", fue devuelto por el especialista de BAW."
                            ...
                            //webex.SendCCNotification(/*employeeCreatorData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - { oppGestion.opp}", oppGestion.opp, msgWebex);
                            webex.SendCCNotification(employeeCreatorData["user"].ToString() + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - {oppGestion.opp}", oppGestion.opp, msgWebex);
                            ...
                            if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                            {
                                ...
                                msgWebex = process.greeting() + $" estimado(a) {employeeName}.\r\n \r\nLe informo que el requerimiento Número de caso: {caseNumber} , de la gestión  #{oppGestion.id} - #{oppGestion.opp} " +
                                          $"del cliente: {client["name"].ToString()} el cual lo asignaron a usted como empleado(a) responsable";
                                msgWebex += ", fue devuelto por el especialista de BAW."
                                 + ".\r\n \r\n En base a su criterio, en caso que tenga permiso puede editar el requerimiento, y volverlo a enviar al especialista. Para ello debe seguir los siguientes pasos:"
                                 + $"\r\n 1. Ingresar a  <a href='{routeSS}'>Smart And Simple</a> de GBM, seguidamente en Ventas - Autopp - Inicio - Mis Solicitudes."
                                + $"\r\n 2. Encontrar la opp {oppGestion.opp}, tocar el botón BAW, hallar el número de caso {caseNumber} y tocar el botón Editar"
                                 + "\r\n3. Por último, editar los datos del requerimiento BAW en base a su criterio y volverlo enviar al especialista."
                                 + "\r\n \r\nSaludos cordiales.";
                                ...
                                //webex.SendCCNotification(/*employeeResponsibleData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - { oppGestion.opp}", oppGestion.opp, msgWebex);
                                webex.SendCCNotification(employeeResponsibleData["user"].ToString() + "@GBM.NET", titleWebex, $"Creación de requerimiento exitoso - {oppGestion.opp}", oppGestion.opp, msgWebex);
                    ...
                    case 6:
                        ...
                        if (oppGestion.opp != "")
                        {
                            ...
                            //webex.SendCCNotification(/*employeeCreatorData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, $"El especialista ha rechazado un requerimiento BAW - { oppGestion.opp}", oppGestion.opp, msgWebex);
                            webex.SendCCNotification(employeeCreatorData["user"].ToString() + "@GBM.NET", titleWebex, $"El especialista ha rechazado un requerimiento BAW - {oppGestion.opp}", oppGestion.opp, msgWebex);
                            ...
                            if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                            {
                                ...
                                //webex.SendCCNotification(/*employeeResponsibleData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, $"El especialista ha rechazado un requerimiento BAW - { oppGestion.opp}", oppGestion.opp, msgWebex);
                            ...
                            //BORRAR CUANDO SE PASE A PRD
                            webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "El especialista ha rechazado un requerimiento BAW", oppGestion.opp, msgWebex);
            ...
            else if (successOrFailMode == "Fail") //Fallo
            {
                ...
                switch (fase)
                {
                    case 1:
                        ...
                        webex.SendCCNotification(employeeCreatorData["user"].ToString() + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex1);
                        ...
                        if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                        {
                            ...
                            //webex.SendCCNotification(/*employeeResponsibleData["user"].ToString()*/"EPIEDRA" + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex1);
                            webex.SendCCNotification(employeeResponsibleData["user"].ToString() + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex1);
                        }


                        //ELIMINAR CUANDO SE PASE A PRD
                        webex.SendCCNotification(/*employeeData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex1);
                    ...
                    case 2:
                        ...
                        if (oppGestion.opp != "")
                        {
                            ...
                            webex.SendCCNotification(employeeCreatorData["user"].ToString() + "@GBM.NET", titleWebex, "Error al crear LDR", oppGestion.opp, msgWebex2);
                            ...
                            if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                            {
                                ...
                                //webex.SendCCNotification(/*employeeResponsibleData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, "Error al crear LDR", oppGestion.opp, msgWebex2);
                                webex.SendCCNotification(employeeResponsibleData["user"].ToString() + "@GBM.NET", titleWebex, "Error al crear LDR", oppGestion.opp, msgWebex2);
                            }


                            //ELIMINAR CUANDO SE PASE A PRD
                            webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Crear Opp en CRM", oppGestion.opp, msgWebex2);
                    ...
                    case 3:
                        ...
                        if (oppGestion.opp != "")
                        {
                            ...
                            webex.SendCCNotification(employeeCreatorData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al crear requerimientos en BAW", oppGestion.opp, msgWebex3);
                            //ELIMINAR CUANDO SE PASE A PRD
                            webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al crear requerimientos en BAW", oppGestion.opp, msgWebex3);
                            ...
                            if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                            {
                                ...
                                webex.SendCCNotification(employeeResponsibleData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al crear requerimientos en BAW", oppGestion.opp, msgWebex3);
                                //webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al crear requerimientos en BAW", oppGestion.opp, msgWebex3);
                            }
                    ...
                    case 4:
                        ...
                        //webex.SendCCNotification(employeeCreatorData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex4);

                        //ELIMINAR CUANDO SE PASE A PRD
                        webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex4);
                        ...
                        if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                        {
                            ...
                            //webex.SendCCNotification(employeeResponsibleData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex4);
                            //webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex4);
                    ...
                    case 5:
                        ...
                        webex.SendCCNotification(employeeCreatorData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex5);

                        //ELIMINAR CUANDO SE PASE A PRD
                        webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex5);
                        ...
                        if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                        {
                            ...
                            webex.SendCCNotification(/*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex5);
                            //webex.SendCCNotification(/*employeeResponsibleData.Usuario*/"EPIEDRA" + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex5);
                    ...
                    case 6:
                        ...
                        webex.SendCCNotification(employeeCreatorData["user"].ToString() + "@GBM.NET", titleWebex, "Error al establecer como rechazado por especialista BAW ", oppGestion.opp, msgWebex6);

                        //ELIMINAR CUANDO SE PASE A PRD
                        webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex6);
                        ...
                        if (employeeCreatorData["user"].ToString() != employeeResponsibleData["user"].ToString())
                        {
                            ...
                            webex.SendCCNotification(employeeResponsibleData["user"].ToString() + "@GBM.NET", titleWebex, "Error al establecer como rechazado por especialista BAW ", oppGestion.opp, msgWebex6);
                            //webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al establecer como rechazado por especialista BAW ", oppGestion.opp, msgWebex6);
                    ...
                    case 7:
                        ...
                        webex.SendCCNotification(employeeCreatorData["user"].ToString()/*"EPIEDRA"*/ + "@GBM.NET", titleWebex, "Error al reenviar el número de caso BAW al especialista", oppGestion.opp, msgWebex7);
                        ...
                        if (employeeCreatorData["user"].ToString() != /*employeeResponsibleData.Usuario*/employeeResponsibleData["user"].ToString())
                        {
                            ...
                            webex.SendCCNotification(employeeResponsibleData["user"].ToString() + "@GBM.NET", titleWebex, "Error al reenviar el número de caso BAW al especialista", oppGestion.opp, msgWebex7);
                            //webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al reenviar el número de caso BAW al especialista", oppGestion.opp, msgWebex7);

                        }

                        //ELIMINAR CUANDO SE PASE A PRD
                        webex.SendCCNotification("EPIEDRA" + "@GBM.NET", titleWebex, "Error al realizar aprobación final en BAW", oppGestion.opp, msgWebex7);
        ...
        public void ProcessAutoppBackUp()
        {
            ...
            if (newOppRequests1.Rows.Count > 0)
            {
                ...
                foreach (DataRow oppReq in newOppRequests1.Rows)
                {
                    ...
                    try
                    {
                        ...
                        //Extraer el nombre del cliente.
                        string sqlClient = $"SELECT name FROM `clients` WHERE `idClient` = {organizationAndClientData.client}";
                        DataTable dtClient = crud.Select(sqlClient, "databot_db");
            ...
            if (newOppRequests2.Rows.Count > 0 && !sap.CheckLogin(mandante))
            {
                ...
                foreach (DataRow oppReq2 in newOppRequests2.Rows)
                {
                    ...
                    try
                    {
                        ...
                        DataTable dtClient2 = crud.Select(sqlClient2, "databot_db");
                ...
                if (subject.Contains("Recibir y verificar solicitud GTL. Número de oportunidad".Replace(" ", "")))
                {
                    ...
                    if (oppRow != null)
                    {
                        ...
                        try
                        {
                            ...
                            countErrorsTable = crud.Select(sql1, "autopp_db");
...
namespace DataBotV5.Automation.WEB.Autopp
{
    ...
    public class AutoppInformation
    {
        ...
        public List<LDRSAutopp> LDRS { get; set; }

...
namespace DataBotV5.Logical.Projects.Modals.Multiple
{
    ...
    class Pos
    {
        public string POS_Cadena { set; get; }
        ...
        public void AsignarCampos()
        {
            ...
            try
            {
                POS_Cadena = POS_Cadena.Replace("undefined", "N/A");
            }
            catch (Exception)
            {
            ...
            string[] token3 = POS_Cadena.Split(new[] { "|" }, StringSplitOptions.RemoveEmptyEntries);
            ...
            I_O_M = token3[29].ToString();

            Comentarios = token3[30].ToString();
        }
    }
}

...
{
    /// <summary>
    /// Clase Logical Kioskos.
    /// </summary>
    class Kioskos
    {
        public string KS_Cadena { set; get; }
        ...
        public void AsignarCampos()
        {
            try
            {
                KS_Cadena = KS_Cadena.Replace("undefined", "N/A");
            }
            catch (Exception)
            {

            }
            string[] token3 = KS_Cadena.Split(new[] { "|" }, StringSplitOptions.RemoveEmptyEntries);
            ...
            Comentarios = token3[13].ToString();
        }
    }
}

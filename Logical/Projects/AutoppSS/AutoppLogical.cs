...
namespace DataBotV5.Logical.Projects.AutoppSS
{
    ...
    /// /// </summary>
    class AutoppLogical : IDisposable
    {
...
";
        ...
        //Link de SAP
        string linkSAP = "http://crm-prod-app.gbm.net:8001/sap/bc/bsp/sap/crm_ui_start/default.htm?sap-domainRelax=min&sap-client=500&sap-language=EN";
        ...
        public void AutoppNotifications(string typeNotification, string user, Dictionary<string, string> toReplace)
        {
            string card = "";
            ...
            card = card.Replace("LINK", linkSAP);
            ...
            catch (Exception e)
            {
                ...
                mail.SendMail(card, "epiedra@gbm.net", $"No se pudo notificar por webex", 2);
